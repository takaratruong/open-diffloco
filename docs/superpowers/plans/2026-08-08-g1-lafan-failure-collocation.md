...
- [ ] **Step 1: Write failing topology and identity-defect tests**
...
- [ ] **Step 3: Implement the minimum topology, defect, and array selector**
...
- [ ] **Step 1: Write a failing physical-parity test**
...
- [ ] **Step 3: Extract the exact existing PD/MJX scan**
...
- [ ] **Step 1: Write failing mathematical identity and finite-gradient tests**
...
- [ ] **Step 3: Implement only the scalar objective, explicit residuals, and slacks**
...
Expected: exit zero; report decision/equality dimensions 1548/852, near-zero identity equalities, finite objective gradient, finite equality JVP, finite constraint JVP, solver 4/5, float64 true, and exact reference hash.
