...
def get_go2_env_class(variant: str = DEFAULT_VARIANT):
    ...
    if variant == "g1_tracking_rmr_50hz_decoupled_exploration":
        return module.G1TrackingRMR50HzDecoupledExplorationEnv
    if variant == "g1_tracking_rmr_50hz_upstream_boundary":
        return module.G1TrackingRMR50HzUpstreamBoundaryEnv
    if variant == "g1_tracking_rmr_50hz_upstream_action_penalty":
        return module.G1TrackingRMR50HzUpstreamActionPenaltyEnv
