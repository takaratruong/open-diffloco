"""Continue exact E008 with a frozen future-minus-current preview."""
...
def build_frozen_delta_preview_kwargs(
    profile_name: str,
    reference_path: str | Path,
    seed: int,
    resume_from: str | Path,
) -> dict:
    """Change only preview representation from the dense E001 contract."""
    ...
    kwargs["actor_reference_preview_mode"] = "delta"
    return kwargs
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("g1_frozen_delta_preview_runs"),
    )
