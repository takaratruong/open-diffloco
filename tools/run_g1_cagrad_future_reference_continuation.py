"""Continue E008 with immutable 0.08/0.16/0.24-second previews."""
...
def build_cagrad_future_reference_kwargs(
    profile_name: str,
    reference_path: str | Path,
    seed: int,
    resume_from: str | Path,
) -> dict:
    """Build the fixed future-reference exact continuation of E008."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Immutable future-reference actor-CAGrad continuation of E008."
    )
    parser.add_argument(
        "--solver-profile",
        required=True,
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("g1_cagrad_future_reference_runs"),
    )
