...
class G1TrackingEnvironmentTest(unittest.TestCase):
    ...
    def test_probe_step_exposes_raw_mjx_fingerprints(self):
        ...
        for name in (
            ...
            "determinism_mjx_substep_field_qfrc_passive_fingerprint",
            "determinism_mjx_substep_field_position_input_qpos_fingerprint",
            "determinism_mjx_substep_field_xpos_fingerprint",
            "determinism_mjx_substep_field_xquat_fingerprint",
            "determinism_mjx_substep_field_xmat_fingerprint",
            "determinism_mjx_substep_field_xipos_fingerprint",
            "determinism_mjx_substep_field_ximat_fingerprint",
            ...
            "determinism_mjx_substep_field_cvel_fingerprint",
            "determinism_mjx_substep_field_cinert_fingerprint",
            "determinism_mjx_substep_field_qfrc_bias_fingerprint",
            "determinism_mjx_substep_field_qfrc_actuator_fingerprint",
            "determinism_mjx_substep_field_actuator_force_fingerprint",
            "determinism_mjx_substep_field_xfrc_applied_fingerprint",
            "determinism_mjx_substep_field_xfrc_accumulated_fingerprint",
